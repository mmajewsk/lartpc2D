class A2CAgent:
    ...
    def append_sample(self, state, action, reward):
        # MM state dims 1x64x64x4
        # MM reward is shape_reward (likely just a float)
        # MM action is coming from get action
        #state here is actually a sample, meaning several images of window
